...
public interface TPEImportRecordRepository extends JpaRepository<TPEImportRecord, Long> {
    ...
    @Query("SELECT r FROM TPEImportRecord r WHERE r.nAffiliation = :nAffiliation")
    Optional<TPEImportRecord> findByNAffiliation(@Param("nAffiliation") String nAffiliation);
